...
<body>
  ...
  <main>
    ...
    <p class="p-institucional">
      En Paw Power, más que una simple hamburguesería, somos un equipo comprometido con la excelencia culinaria y la
    ...
    <section class="equipoTrabajo">
      ...
      <p class="p-institucional">
        Nuestro equipo está formado por profesionales apasionados y comprometidos que comparten nuestra visión de
        ofrecer
        experiencias gastronómicas excepcionales. Desde nuestros expertos cocineros hasta nuestro amable personal de
        servicio,
        cada miembro desempeña un papel fundamental en nuestro éxito. Trabajamos juntos con pasión y dedicación para
        superar las
